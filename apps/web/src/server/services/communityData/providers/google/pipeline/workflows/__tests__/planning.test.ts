...
import { loadBaseCachePlan } from "@web/src/server/services/communityData/providers/google/pipeline/workflows/planning";
...
describe("google planning workflow", () => {
  ...
  it("splits category and neighborhood cache hits from misses", async () => {
    ...
    expect(result.cachedNeighborhoodLists.get("neighborhoods_general")).toBe(
      "- General"
    );
