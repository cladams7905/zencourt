import { normalizeAudienceSegment } from "@web/src/server/services/community/shared/audience";
...
describe("normalizeAudienceSegment", () => {
  ...
  it("normalizes aliases", () => {
    ...
    expect(normalizeAudienceSegment("first_time_buyers")).toBe("first_time_homebuyers");
  });

  it("returns normalized segment when already valid", () => {
    expect(normalizeAudienceSegment("growing_families")).toBe("growing_families");
  });
