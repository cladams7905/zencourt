...
} from "@web/src/server/services/community/providers/google/core/seasonal";
...
describe("google seasonal", () => {
  ...
  it("selects a capped set of seasonal categories", () => {
    const picked = pickSeasonalCategories("seed", ["dining", "coffee_brunch", "education"] as never, 2);
