...
jest.mock("@web/src/server/services/community/providers/google/core/places", () => ({
  buildNeighborhoodDetailList: (...args: unknown[]) => mockBuildNeighborhoodDetailList(...args),
...
jest.mock("@web/src/server/services/community/providers/google/core/seasonal", () => ({
  buildSeasonalQuerySections: (...args: unknown[]) => mockBuildSeasonalQuerySections(...args),
  CATEGORY_FIELD_MAP: {
    dining: "dining_list",
...
jest.mock("@web/src/server/services/community/providers/google/pipeline/shared", () => ({
  getPlaceDetailsCached: (...args: unknown[]) => mockGetPlaceDetailsCached(...args),
  communityCache: {
    getCachedSeasonalSections: (...args: unknown[]) => mockGetCachedSeasonalSections(...args),
    setCachedSeasonalSections: (...args: unknown[]) => mockSetCachedSeasonalSections(...args),
...
} from "@web/src/server/services/community/providers/google/pipeline/workflows/assembly";
