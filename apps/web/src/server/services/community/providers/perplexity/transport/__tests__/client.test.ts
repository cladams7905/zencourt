...
import { requestPerplexity } from "@web/src/server/services/community/providers/perplexity/transport/client";
...
describe("perplexity client", () => {
  ...
  it("returns null when api key is missing", async () => {
    ...
    await expect(
      requestPerplexity({ messages: [{ role: "user", content: "hello" }] as never })
    ).resolves.toBeNull();
