...
export function mapSavedReelContentToCreateItem(
  ...
  return {
    ...
    overlayBackground: metadata.overlayBackground ?? null,
    overlayPosition: metadata.overlayPosition ?? null,
    overlayFontPairing: metadata.overlayFontPairing ?? null,
    showAddress: metadata.showAddress ?? null,
