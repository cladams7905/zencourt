...
jest.mock("@web/src/server/actions/contentGeneration/context", () => ({
...
jest.mock("@web/src/server/actions/contentGeneration/promptLog", () => ({
  writePromptLog: (...args: unknown[]) =>
    (mockWritePromptLog as (...a: unknown[]) => unknown)(...args)
}));

jest.mock("@web/src/server/actions/contentGeneration/stream", () => ({
