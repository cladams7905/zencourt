import { Play, TrendingUp, Sparkles, Bookmark, Heart, MessageCircle, Send, Music } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-body-md text-muted-foreground max-w-xl mx-auto">
            Explore examples of high-converting content generated by Zencourt's
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
          ...
          <div className="break-inside-avoid relative rounded-2xl overflow-hidden shadow-md group cursor-pointer">
            <div className="aspect-[9/16] bg-gradient-to-br from-accent/20 to-secondary relative">
          ...
          <div className="break-inside-avoid bg-background rounded-2xl border border-border shadow-md overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <div className="aspect-square bg-gradient-to-br from-secondary to-accent/20 relative" />
            <div className="p-4">
          ...
          <div className="break-inside-avoid relative rounded-2xl overflow-hidden shadow-lg group hover:ring-4 ring-accent/30 transition-all">
            <div className="aspect-[9/15] bg-gradient-to-br from-accent/30 to-secondary relative">
          ...
          <div className="break-inside-avoid bg-background rounded-2xl border border-border shadow-md overflow-hidden">
            <div className="relative">
              <div className="w-full aspect-[4/3] bg-gradient-to-br from-secondary to-accent/20" />
          ...
          {/* TikTok Style Reel */}
          <div className="break-inside-avoid relative rounded-2xl overflow-hidden shadow-md group cursor-pointer">
            <div className="aspect-[9/16] bg-gradient-to-br from-secondary to-accent/10 relative">
