...
import { SettingsUnsavedChangesDialog } from "@web/src/components/settings/subcomponents/SettingsUnsavedChangesDialog";
...
describe("SettingsUnsavedChangesDialog", () => {
  ...
  it("intercepts internal navigation and supports discard", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Save changes before leaving?")
      ).toBeInTheDocument();
    });
