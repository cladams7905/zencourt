...
import { ListingVideoPreviewGrid } from "@web/src/components/listings/create/components/ListingVideoPreviewGrid";
...
jest.mock(
  "@web/src/components/listings/create/media/video/videoPreviewViewModel",
  () => ({
...
jest.mock(
  "@web/src/components/listings/create/media/video/components/VideoPreviewCard",
  () => ({
...
jest.mock(
  "@web/src/components/listings/create/media/video/components/VideoPreviewModal",
  () => ({
      ...
      return (
        <div>
          ...
          <div data-testid="modal-selected-preview-id">
            {String(
              (props.selectedPreview as { id?: string } | null | undefined)?.id ??
                ""
            )}
          </div>
...
describe("ListingVideoPreviewGrid", () => {
  ...
  it("preserves download state for the same reel across modal close and reopen", async () => {
    ...
    expect(screen.getByTestId("modal-download-progress")).toHaveTextContent("0");
