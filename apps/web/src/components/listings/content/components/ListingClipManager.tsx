...
} from "@web/src/components/listings/content/domain/clipManager";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
} from "@web/src/components/listings/content/components/ListingClipManagerWorkspaceParts";
...
function buildClipsHref(listingId: string, search: string) {
  ...
  return `/listings/${listingId}/content/clips${query}`;
}
