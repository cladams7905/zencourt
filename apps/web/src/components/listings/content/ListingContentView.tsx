...
type ListingContentViewProps = {
   ...
   * above the listing header. Defaults to {@link LISTING_CONTENT_FILTER_EXTRA_TOP_BANNER_PX}.
   */
  stickyFilterExtraTopBannerPx?: number;
};

export type { ListingContentMediaTab } from "@web/src/components/listings/content/shared/constants";
...
export function ListingContentView({
  ...
  stickyFilterExtraTopBannerPx = LISTING_CONTENT_FILTER_EXTRA_TOP_BANNER_PX
}: ListingContentViewProps) {
  const pathname = usePathname();
  const filterStickyTopOffsets = React.useMemo(
    () => getListingContentFilterStickyTopOffsets(stickyFilterExtraTopBannerPx),
...
export const ListingAddressView = ListingContentView;
