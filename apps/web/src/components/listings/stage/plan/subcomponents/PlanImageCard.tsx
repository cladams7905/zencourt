...
import type { ListingImageItem } from "@web/src/components/listings/stage/plan/shared";
import type { CameraMotionVariantId } from "@shared/types/models";

type PlanImageCardSize =
  | "accordion"
  | "strip"
  | "dock"
  | "row"
  /** Taller thumbnails inside room accordions (plan workspace). */
  | "categoryRow";

type PlanImageCardProps = {
  image: ListingImageItem;
  size?: PlanImageCardSize;
...
function DragMoveHint({ size }: { size: PlanImageCardSize }) {
