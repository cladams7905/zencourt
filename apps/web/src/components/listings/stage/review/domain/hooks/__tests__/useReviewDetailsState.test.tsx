...
import { useReviewDetailsState } from "@web/src/components/listings/stage/review/domain/hooks/useReviewDetailsState";
...
describe("useReviewDetailsState", () => {
  ...
  it("normalizes list sections to null when empty", () => {
    ...
    expect(
      result.current.details.valuation_estimates?.third_party_examples
    ).toBeNull();
  });
