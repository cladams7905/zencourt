  ...
  try {
    ...
    if (
      ...
      throw new ApiError(400, {
        ...
        message: "compositionSettings.roomOrder is required and must not be empty"
      });
    }
    ...
    if (!response.ok) {
      ...
      if (response.status === 503) {
        throw new ApiError(503, {
          ...
          message: "The video processing server is currently at capacity. Please try again later."
        });
      }
      ...
      if (response.status >= 500) {
        throw new ApiError(502, {
          ...
          message: "The video processing server encountered an error. Please try again."
        });
      }
